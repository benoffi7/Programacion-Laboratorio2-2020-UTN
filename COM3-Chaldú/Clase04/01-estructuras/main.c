    ...
    do{
        ...
        switch(opcion){
            ...
            case 50:
                ...
                break;
            case 54:
                lista = archivo2lista(lista, AR_EMPLEADOS);
                muestraLista(lista);
                getch();
                break;
...
void muestraMenu(){
    ...
    printf("\n 6 - Pasa archivo a lista de Empleados");
    printf("\n\n          ESC para salir....");
...
nodo* archivo2lista(nodo* lista, char archivo[]){
    ...
    while(fread(&empleado, sizeof(stEmpleado), 1, archi) >0){
        lista = agregarAlPrincipio(lista, crearNodo(empleado));
    }
    return lista;
}
